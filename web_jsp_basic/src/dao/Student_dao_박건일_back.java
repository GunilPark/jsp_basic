...
public class Student_dao_박건일_back {
	Connection con = null;
	...
	public int getTotalCount(String selectYear, String selectClass1, String selectClass2,
			String selectClass3, String selectClass4, String selectClass5, String selectNN, String search) {
		int count = 0;
		String[] selectClass = { selectClass1, selectClass2, selectClass3, selectClass4, selectClass5 };
		...
		if(selectClass[0].equals("000") && selectClass[1].equals("000") && selectClass[2].equals("000") && selectClass[3].equals("000") && selectClass[4].equals("000")){
			selectClass[0] = "1";
			selectClass[1] = "2";
			selectClass[2] = "3";
			selectClass[3] = "4";
	...
	public ArrayList<Student_dto_박건일> getStudentListPage(String selectYear, String selectClass1, String selectClass2,
			String selectClass3, String selectClass4, String selectClass5, String selectNN, String search, int start, int end) {
		ArrayList<Student_dto_박건일> dtos = new ArrayList<>();
	...
	public ArrayList<Student_dto_박건일> getStudentListIN(String selectYear, String selectClass1, String selectClass2,
			String selectClass3, String selectClass4, String selectClass5, String selectNN, String search) {
		ArrayList<Student_dto_박건일> dtos = new ArrayList<>();
...
//리스트 생성
	public ArrayList<Student_dto_박건일> getStudentListOrAnd(String selectYear, String selectClass1, String selectClass2,
			String selectClass3, String selectClass4, String selectClass5, String selectNN, String search) {
		ArrayList<Student_dto_박건일> dtos = new ArrayList<>();
		...
		if (selectYear.equals("all")) {
			for (int k = 0; k < 5; k++) {
				if (selectClass[k].equals(Integer.toString(k + 1) + "") && cnt == 0) {
					query += "where sclass = '" + selectClass1 + "'\r\n";
					query += "and " + selectNN + " " + likeEqu + "\r\n";
					cnt++;
				}
			}
